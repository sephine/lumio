...
#define INITIAL_COUNTDOWN_SPEED_IN_PERCENTAGE_PER_SECOND 3.0
#define LEVEL_1_TO_3_COUNTDOWN_SPEED_INCREASE 0.5
#define LEVEL_4_TO_5_COUNTDOWN_SPEED_INCREASE 0.25
